          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
              ...
              <div className="text-right">
                ...
                <div className="text-sm text-gray-600">96% accuracy</div>
              </div>
            </div>
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
              <div>
                ...
                <div className="text-sm text-gray-600">Common words drill</div>
              </div>
              <div className="text-right">
                <div className="font-bold text-green-600">92 WPM</div>
                <div className="text-sm text-gray-600">98% accuracy</div>
              </div>
            </div>
          </div>
        </div>
