...
const HomePage: React.FC<HomePageProps> = ({
  ...
  return (
    <div
      className={`HomePage w-full max-w-5xl py-8 px-8 transition-colors duration-300 ${
      ...
      <div className="w-full text-center">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p
              className={`text-lg mb-6 max-w-3xl mx-auto transition-colors duration-300 ${
                isDarkMode ? 'text-gray-300' : 'text-gray-700'
              }`}
            >
        ...
        >
          <h3
            className={`text-2xl font-bold mb-6 text-center flex items-center justify-center gap-3 transition-colors duration-300 ${
